...
def load_data(dataset_fv):
    ...
    for i in range(len(data_vnames)):
        with open("data/ind.{}.{}".format(dataset_fv, data_vnames[i]), 'rb') as f:
    ...
    test_idx_reorder = parse_index_file("data/ind.{}.test.index".format(dataset_fv))
    test_idx_range = np.sort(test_idx_reorder)

    if dataset_fv == 'citeseer':
